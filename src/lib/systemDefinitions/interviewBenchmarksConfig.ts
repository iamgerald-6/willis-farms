...
export const INTERVIEW_BENCHMARK_FIELD_DEFS: {
  ...
  },
  {
    ...
    label: "Hire minimum",
    description:
      "Minimum combined score for HR to confirm hire. WillsOne Intel must not recommend hire below this.",
  },
  {
    key: "holdMin",
  ...
  },
  {
    ...
    description:
      "Minimum Stage 1 average for WillsOne Intel to recommend advancing to Stage 2.",
  },
  {
    key: "stage2AdvanceMin",
    label: "Stage 2 → Evaluation",
    description:
      "Minimum Stage 2 average for WillsOne Intel to support proceeding to final evaluation.",
  },
];
