              ...
              {sourceMode === "upload" ? (
                <>
                  <p className="text-sm text-gray-500 mb-4">
                    ...
                    pages). If you upload more than one, WillsOne Intel reads them
                    ...
                    obligations for WillsOne Intel to get through in one pass, will
            ...
            <>
              <p className="text-sm text-gray-500 mb-1">
                {selectPagesReason === "pages"
                  ...
                  : `${pendingBatch.length > 1 ? "These documents have" : "This document has"} too many obligations for WillsOne Intel to read in one pass.`}
              </p>
              <p className="text-sm text-gray-500 mb-4">
