      ...
      <div className="rounded-xl border border-purple-100 bg-purple-50/60 p-4 space-y-3">
        ...
        {!readOnly && !allDisqualifiersAnswered && (
          <p className="text-xs text-amber-700 bg-amber-50 border border-amber-100 rounded-lg px-3 py-2">
            Answer every item in the critical concerns checklist above (yes or no) before generating the WillsOne Intel analysis.
          </p>
        )}
        ...
        {formData.summary?.ai_analysis ? (
          <>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              >
                WillsOne Intel recommends: {RECOMMENDATION_LABELS[formData.summary.ai_recommendation ?? "hold"]}
              </span>
          ...
          <p className="text-xs text-purple-700">
            Get a quick WillsOne Intel read of the full Stage 1 + Stage 2 record before deciding.
          </p>
        )}
      </div>
